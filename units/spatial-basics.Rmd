...
This matrix gives the position of points along the boundary of one of Currituck county's landmasses. Geospatial data represents points on the earth in terms of longitude and latitude with respect to a __datum__. The same point can have different longitudes and latitudes with respect to different datums.
