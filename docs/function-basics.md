...
<small>(Leads to: [Predicate functions](function-predicate.md), [Vector functions](function-vector.md), [purrr basics](purrr-basics.md), [Tidy evaluation](tidy-eval.md))</small>
